...
function MainPage(){
    ...
    const handleSubmit= async (e)=>{
        ...
        const response = await axios.get("https://backend-4-gv2z.onrender.com/convert",{params:{date,sourceCurrency,tCurrency,amount,},});
    ...
    useEffect(()=>{
        ...
        const getList = async ()=>{
            ...
            try{
              ...
              const responce = await axios.get("https://backend-4-gv2z.onrender.com/getAllCurrency",{
